...
class RoomGenerator:
    ...
    def generate_tunnels(self, tunnel_width: int, rooms: list[RectangularRoom]) -> list[RectangularRoom]:
        tunnels = []
    ...
    def create_horizontal_and_verticle_tunnel(self, staring_room: RectangularRoom, ending_room: RectangularRoom, tunnel_width=1) -> list[RectangularRoom]:
